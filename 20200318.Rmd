...
str_detect(studentGithubURLs,"https://github.com/[:graph:]+ (/108-2-56-inclass-practice|/108-2-78-inclass-practice)")
...
"(?<=exam1-)4[0-9]{8}|(?<=exam1)4[0-9]{8}|4[0-9]{8}|3[0-9]{8}")
